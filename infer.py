...
singer="singer" # 模型文件夹的名称
music="music.wav" # raw文件夹下输入的音频文件的名称
model="model_ckpt_steps_242000.ckpt" # 你模型文件的名称
...
if __name__ == '__main__':
    # 工程文件夹名，训练时用的那个
    project_name = f"{singer}"
    model_path = f'./checkpoints/{project_name}/{model}'
